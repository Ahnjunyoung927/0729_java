package com.kh.chap05.counstructor.model.vo;
...
public class Member {
	 ...
	 * 
	 * 생성자의 역할
	 * -- 기술적인 관점 : 객체가 생성될 때 어떤 상태로 시작해야하는가
	...
	public Member() { // <-- 기본생성자는 무조건 꼭 있어야 함
	 ...
	 * 4. 생성자는 동일한 이름으로 여러개 생성이 가능하지만 매개변수가 중복되어선 안됨 => 생성자 오버로딩
	 */
	
	/*
	 * 2025 / 08 / 07 오늘의 실습 겸 숙제
	 * 
	 * 기존에 만들어 두었던 다섯개의 VO클래스 및 실행 클래스를
	 ...
	 * 5) 직접 접근으로 사용하고 있던 실행 클래스의 코드들을 전부 다 getter / setter 대체
	 */
