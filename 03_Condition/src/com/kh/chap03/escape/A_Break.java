...
public class A_Break {
	...
	/*
	 * **주의사항 : switch문 내부에 작성하는 break문과는 구분을 해야함
	...
	public void method1() {
		// 무한 반복하면서 랜덤한 정수(1 ~ 100)을 생성해서 출력하다가
		// 50이 생성되면 반복을 중단
	...
	public void method2() {
		...
		while(true) {
			System.out.print("문자열을 입력해주세요.(종료를 원하신다면 'exit'을 입력해주세요.) > ");
	...
	// 만약 입력한 숫자가 0보다 작으면 " 프로그램을 종료합니다 "라는 문구를 출력하고 종료하시오
	...
	public void method4() {
		...
		/*
		 * 사용자로부터 한개의 정수값을 입력받아서
		 * 입력받은 숫자부터 1까지의 모든 숫자를 출력하기
		 * 
		 * 단, 입력받는 정수는 1이상이어야 함.
		 * 
