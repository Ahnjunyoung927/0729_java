...
public class FileRun {
	...
	try {
		// 파일 만들기
		file1.createNewFile(); // creatNewFile() : 파일생성 메소드
		...
		// 파일클래스에서 제공하는 메소드
		System.out.println("파일 맞니 ? " + file1.isFile());
	 ...
	 * 보조 스트림 : 기반스트림만으로 부족한 성능을 향상 시켜주는 용도로 만들어진 스트림
	 *                => 단독 사용불가(반드시 기반스트림이 존재해야만 사용이 가능함)
	 *                => 속도향상, 자료형에 맞춰 변환, 객체단위로 입출력, 바이트 <==> 문자
	 * 
	 * 
	 * 
	 * 
