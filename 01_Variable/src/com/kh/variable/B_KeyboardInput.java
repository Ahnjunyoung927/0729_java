...
public class B_KeyboardInput {
	...
	public void inputTest() {
		...
		// 2절. 클래스의 별칭을 지어주면서 new를 생성 해줌
		Scanner sc = new Scanner(System.in);
		// System.in : 표준 입력 도구에서 입력받은 값들을 받겠다.(바이트 단위)
		
		// 사용자게 주문할 음료를 입력받아서 출력해보기
		
		// 입력 받고자 하는 내용을 알려주거나 먼저 질문을 해서 입력을 유도
		System.out.println("별다방에 오신 것을 환영합니다.");
		System.out.println("=========메뉴판=========");
		System.out.println("한교동 갈릭쉬림프 프레첼");
		System.out.println("모카 프라푸치노");
		System.out.println("바닐라 아이스크림");
		System.out.println("======================");
		System.out.print("주문 하실 메뉴를 입력해주세요 > ");
		
		// next(); : 사용자가 입력한 값을 입력받음. 아래 console에 입력기능이 생김
		// 공백이 있을 경우 공백문자 이전까지만 입력받음
		String menu = sc.next();
		...
		System.out.println(menu + "을(를) " + count + "개 주문하셨습니다.");
		...
		System.out.println(menu + " " + count + "개를 " + address + "(으)로 배달합니다.");
