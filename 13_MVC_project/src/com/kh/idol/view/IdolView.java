...
public class IdolView {
	...
	public void mainMenu() {
		...
		System.out.println("💁‍♀aespa 커뮤니티에 오신 것을 환영합니다.");
	...
	private void signUp() {
		...
		System.out.println("에스파 커뮤니티에 오신 것을 환영합니다.");
		...
		// 하나의 메소드는 하나의 기능만 수행해야한다
		// 하지만 지금 이 회원가입 메소드는
		// 회원가입 뿐만 아니라 아이디값에 대한 유효성 검증을 하고 있다
		// 이렇게되면 이 메소드는 하는 일이
		// 1. 유효성 검증
		// 2. 회원가입
		// 두개가 되어버리기 때문에 하는 일이 너무 많은 것이다.
		// 분리를 하는 것이 올바르지만 아직은 너무 이르므로 추후에 다시
		...
		// 사용자가 입력한 아이다, 비밀번호, 닉네임을 가지고
		// Fan객체를 생성해서 필드에 담아서 Controller에 있는
		// fans라는 List의 요소로 추가
