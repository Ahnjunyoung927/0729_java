...
public class Run {
	...
	public static void main(String[] args) {
		...
		for(String name : names) {
			System.out.println(name + "은(는) 정말 못 말려");
		}
		System.out.println("==================================");
		names.stream().map(name -> name + "은(는) 못말려").forEach(System.out::println);
		// 함수형 프로그래밍 방식, 선언식 프로그래밍
		System.out.println("==================================");
		
		// 스트림(Stream)
		// 컬렉션, 배열 등의 데이터를 선언적을 처리해주는 API
		// for문 -> 어떻게 반복하는지가 구체적
		// 함수형 -> 무엇을 할지 행위에 집중
		// 파이프라이닝 -> 여러 연산을 연결
		 ...
		 * a -> a;
		 */
		// 익명클래스 -> 선언과 동시에 객체를 생성하는 것, 이 클래스 내부에서만 사용하는 1회성
		...
		// filter => 조건에 맞는 것만 필터링 할 수 있음, if문의 역할
		...
		coffee.stream().map(c -> c + "의 길이 : " + c.length())//.forEach(l -> System.out.println(l));
